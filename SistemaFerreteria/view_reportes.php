...
<body>
     ...
     <div class="contenedor-botones-gestionar-usuarios">
      <center>
       <a href="view_reporte_fecha.php" class="btn btn-outline-dark btn-instertar-tema" style="color: #0041FF; border-color: #3d73a9" >Reporte por fecha</a>
       <a href="reporte_productos.php" class="btn btn-outline-dark btn-instertar-tema" style="color: #0041FF; border-color: #3d73a9" >Reporte productos</a>
     </center>
