...
<body>
     ...
     <?php
        ...
        $consulta = $conexion->query("SELECT * from venta where id = '$id'");
      ?>
    ...
    <h1 class="titulo-principal">Editar Cantidad</h1>
		...
		<?php } ?>
    <a href="view_venta.php" class="btn btn-outline-dark btn-regresar"><i class="fa fa-chevron-left"></i> Regresar</a>
